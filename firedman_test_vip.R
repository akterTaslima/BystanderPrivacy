...
#lt = c("1","3","5")
pdf("Interaction-comfort-vip.pdf", 6.6, 6)
p <- ggline(comfort_data, x = "degree", y = "comfort",  add = c("mean_ci"), color = "information", linetype = "information", 
       shape = "information", size = 1, point.size = 5,
...
ggpar(p, legend.title = "Information", font.legend=16, font.x = 18, font.y=18) 
dev.off()
...
pdf("Interaction-useful-vip.pdf", 6.5, 6)
p <- ggline(useful_data, x = "degree", y = "useful", color = "information", add = c("mean_ci"), linetype = "information", 
       shape = "information", size = 1, point.size = 5,
